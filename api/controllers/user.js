...
function pruebas(req, res){
	res.status(200).send({
		message: 'Probando aqui cositas del controlador de usuario con node y mongo xD'
	});
}
/*guardar usuario
...
function updateUser(req,res){
	...
	if (userId != req.user.sub) {
		return res.status(500).send({message: 'No hay permiso para actualizar este usuario'});
	}
